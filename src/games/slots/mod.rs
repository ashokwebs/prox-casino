...
impl SlotSymbol {
    ...
    pub fn short_name(self) -> &'static str {
        match self {
            SlotSymbol::Cherry => "CHRY",
            SlotSymbol::Lemon => "LMON",
            SlotSymbol::Bell => "BELL",
            SlotSymbol::Seven => "SEVN",
            SlotSymbol::Diamond => "DIAM",
            SlotSymbol::Wild => "WILD",
            SlotSymbol::Scatter => "SCAT",
            SlotSymbol::Crown => "CRWN",
            SlotSymbol::Flame => "FLME",
            SlotSymbol::Cyber => "CYBR",
            SlotSymbol::Bar => "BAR ",
            SlotSymbol::DoubleBar => "DBAR",
            SlotSymbol::TripleBar => "TBAR",
            SlotSymbol::Horseshoe => "HORSE",
            SlotSymbol::Coin => "COIN",
            SlotSymbol::Heart => "HEART",
            SlotSymbol::Star => "STAR",
            SlotSymbol::GoldBar => "GOLD",
        }
    }
